                                    ...
                                    <div className="row" >
                                        <div className="col-md-3">
                                            <img
                                                ...
                                                style={{ maxHeight: 'auto', maxWidth: '100%', maxHeight: '200px' }}
                                                alt="user profile"
                                            />
                                        </div>
                                        <div className="col-md-9">
                                            ...
                                            <p className=" h4 text-muted">{user.about}</p>
                                        </div>
                ...
                <div className="container pb-5">
                    <div className="row">
                        <div className="col-md-6">
                            <div className="card">
                                <div className="card-body">
                                    <h5 className="card-title bg-primary pt-4 pb-4 pl-4 pr-4 text-light">Recent blogs by <span className="text-capitalize">{user.username}</span></h5>
                                    {showUserBlogs()}
                                </div>
                            </div>
                        </div>
